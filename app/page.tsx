...
function InfoCard({title,Icon,children}:IInfoCardProps) {
  return (
    <div className='w-full h-80  flex flex-col justify-around items-center p-8 bg-gray-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-20'>
